Akash Provider for Kubernetes Hard Multi-Tenancy
------------------------------------------------
...
## Domain: CGroups/Host system/Kernel
...
There are use cases where running as root might be necessary, and the provider with appropriate consideration and controls would allow such operations. eg: Workloads which interface the GPU. This sort of risk needs to be managed by the providers and will be part of their selectable attributes.

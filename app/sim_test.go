...
func TestFullAppSimulation(t *testing.T) {
	...
	app1 := NewApp(logger, db, nil, true, simapp.FlagPeriodValue, map[int64]bool{}, DefaultHome,
...
func TestAppImportExport(t *testing.T) {
	...
	app := NewApp(logger, db, nil, true, simapp.FlagPeriodValue, map[int64]bool{}, DefaultHome,
		simapp.EmptyAppOptions{}, fauxMerkleModeOpt)
	...
	newApp := NewApp(log.NewNopLogger(), newDB, nil, true, simapp.FlagPeriodValue, map[int64]bool{}, DefaultHome,
		simapp.EmptyAppOptions{}, fauxMerkleModeOpt)

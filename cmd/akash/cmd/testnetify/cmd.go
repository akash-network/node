...
import (
	...
	ibccltypes "github.com/cosmos/ibc-go/v8/modules/core/02-client/types"
	ibcchtypes "github.com/cosmos/ibc-go/v8/modules/core/04-channel/types"
)
...
func loadGenesis(cmd *cobra.Command, file string) (genesisState map[string]json.RawMessage, genDoc *tmtypes.GenesisDoc, err error) {
	...
	genesisState, _, err = genutiltypes.GenesisStateFromGenFile(file)
	return genesisState, genDoc, err
}

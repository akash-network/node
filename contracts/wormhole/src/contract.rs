use cosmwasm_std::{
    ...
    Response, StdError, StdResult, Storage, Uint256, WasmMsg,
};
...
use crate::{
    ...
    state::{
        guardian_set_get, guardian_set_set, sequence_read, sequence_set,
...
fn parse_and_verify_vaa(
    ...
    for _ in 0..vaa.len_signers {
        ...
        let recovery_byte = data.get_u8(pos + ParsedVAA::SIG_RECOVERY_POS);

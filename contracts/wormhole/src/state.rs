...
use cosmwasm_std::{Binary, CanonicalAddr, Coin, StdResult, Storage, Uint256};
...
pub const GUARDIAN_SETS: Map<&[u8], GuardianSetInfo> = Map::new("guardian_set");
pub const SEQUENCES: Map<&[u8], u64> = Map::new("sequence");

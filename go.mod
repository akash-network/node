...
replace (
	...
	// akash tendermint (actually 34.24, haven't tagged)
	github.com/tendermint/tendermint => github.com/notional-labs/tendermint v0.34.14-0.20221122204837-10fe92771f41

	// akash human interface device

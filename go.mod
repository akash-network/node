...
require (
	...
	pkg.akt.dev/go v0.0.2-rc4
	pkg.akt.dev/go/cli v0.0.2-rc3
	pkg.akt.dev/go/node/migrate v0.0.3
...
replace (
	...
	// pin gogoproto version for compatibility with cosmos-sdk as some dependency
	// pulling it up

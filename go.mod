...
replace (
	...
	// use informal system fork of tendermint with akash patches
	// To be replaced by cometBFT fork during migration to cosmo-sdk v0.46.x
	github.com/tendermint/tendermint => github.com/akash-network/tendermint v0.34.26-akash

...
replace (
	...
	// todo remove this import post upgrade
	github.com/akash-network/akash-api => github.com/akash-network/akash-api v0.0.82-eol.5
	...
	pkg.akt.dev/go/cli => ../chain-sdk/go/cli
)

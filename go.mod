...
replace (
	...
	github.com/tendermint/tendermint => github.com/notional-labs/tendermint v0.34.14-0.20221011024438-10756188de94
	// fix the version of grpc to one compatible with cosmos-flavored protobufs

...
type InventorySpec struct {
	// Nodes   []InventoryClusterNode    `json:"nodes"`
...
// type InventoryClusterNode struct {
// 	Name             string       `json:"name,omitempty"`
// 	CPU              ResourcePair `json:"cpu,omitempty"`
// 	Memory           ResourcePair `json:"memory,omitempty"`
// 	EphemeralStorage ResourcePair `json:"ephemeral_storage,omitempty"`
// 	VolumesAttached  ResourcePair `json:"volumes_attached,omitempty"`
// 	VolumesMounted   ResourcePair `json:"volumes_mounted,omitempty"`
// }

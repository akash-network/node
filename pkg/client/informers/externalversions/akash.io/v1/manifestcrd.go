	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1().ManifestCRDs(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1().ManifestCRDs(namespace).Watch(options)
			},
		},
		&akash_io_v1.ManifestCRD{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *manifestCRDInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&akash_io_v1.ManifestCRD{}, f.defaultInformer)
}

...
func Test_ScalePricingRejectsAllZero(t *testing.T) {
	pricing, err := MakeScalePricing(0, 0, 0)
	require.NotNil(t, err)
	require.Nil(t, pricing)
}

func Test_ScalePricingAcceptsOneForASingleScale(t *testing.T) {
	pricing, err := MakeScalePricing(1, 0, 0)
	require.NoError(t, err)
	require.NotNil(t, pricing)

	pricing, err = MakeScalePricing(0, 1, 0)
	require.NoError(t, err)
	require.NotNil(t, pricing)

	pricing, err = MakeScalePricing(0, 0, 1)
	require.NoError(t, err)
	require.NotNil(t, pricing)
}
...
func Test_ScalePricingFailsOnOverflow(t *testing.T) {
	pricing, err := MakeScalePricing(math.MaxUint64, 0, 0)
	require.NoError(t, err)
	require.NotNil(t, pricing)
...
func Test_ScalePricingOnCpu(t *testing.T) {
	cpuScale := uint64(22)
	pricing, err := MakeScalePricing(cpuScale, 0, 0)
	require.NoError(t, err)
	require.NotNil(t, pricing)
...
func Test_ScalePricingOnMemory(t *testing.T) {
	...
	pricing, err := MakeScalePricing(0, memoryScale, 0)
	require.NoError(t, err)
	require.NotNil(t, pricing)
...
func Test_ScalePricingOnStorage(t *testing.T) {
	...
	pricing, err := MakeScalePricing(0, 0, storageScale)
	require.NoError(t, err)
	require.NotNil(t, pricing)

...
func NewIngress(log log.Logger, settings Settings, lid mtypes.LeaseID, group *manitypes.Group, service *manitypes.Service, expose *manitypes.ServiceExpose) Ingress {
	builder := &ingress{

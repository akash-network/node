...
func (_m *HostnameServiceClient) PrepareHostnamesForTransfer(ctx context.Context, hostnames []string, leaseID v1beta2.LeaseID) error {
	ret := _m.Called(ctx, hostnames, leaseID)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, v1beta2.LeaseID) error); ok {
...
func (_m *HostnameServiceClient) ReleaseHostnames(leaseID v1beta2.LeaseID) error {
	ret := _m.Called(leaseID)

	var r0 error
	if rf, ok := ret.Get(0).(func(v1beta2.LeaseID) error); ok {
		r0 = rf(leaseID)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *HostnameServiceClient) ReserveHostnames(ctx context.Context, hostnames []string, leaseID v1beta2.LeaseID) ([]string, error) {
	ret := _m.Called(ctx, hostnames, leaseID)

	var r0 []string
	if rf, ok := ret.Get(0).(func(context.Context, []string, v1beta2.LeaseID) []string); ok {
		r0 = rf(ctx, hostnames, leaseID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, []string, v1beta2.LeaseID) error); ok {

...
func (_m *Service) FindActiveLease(ctx context.Context, owner types.Address, dseq uint64, gseq uint32) (bool, v1beta2.LeaseID, v1.ManifestGroup, error) {
...
func (_m *Service) Reserve(_a0 v1beta2.OrderID, _a1 typesv1beta2.ResourceGroup) (clustertypes.Reservation, error) {
	ret := _m.Called(_a0, _a1)

	var r0 clustertypes.Reservation
	if rf, ok := ret.Get(0).(func(v1beta2.OrderID, typesv1beta2.ResourceGroup) clustertypes.Reservation); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {

...
func (_m *Client) Validate(_a0 context.Context, _a1 v1beta2.GroupSpec) (provider.ValidateGroupSpecResult, error) {
	ret := _m.Called(_a0, _a1)

	var r0 provider.ValidateGroupSpecResult
	if rf, ok := ret.Get(0).(func(context.Context, v1beta2.GroupSpec) provider.ValidateGroupSpecResult); ok {
		r0 = rf(_a0, _a1)
	} else {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, v1beta2.GroupSpec) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}

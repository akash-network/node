...
// NewMutatingWebhookConfigurationInterface creates a new instance of MutatingWebhookConfigurationInterface. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMutatingWebhookConfigurationInterface(t testing.TB) *MutatingWebhookConfigurationInterface {

...
// NewAppsV1Interface creates a new instance of AppsV1Interface. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAppsV1Interface(t testing.TB) *AppsV1Interface {

...
func (_m *DeploymentInterface) Create(ctx context.Context, deployment *v1beta2.Deployment, opts v1.CreateOptions) (*v1beta2.Deployment, error) {
	ret := _m.Called(ctx, deployment, opts)

	var r0 *v1beta2.Deployment
	if rf, ok := ret.Get(0).(func(context.Context, *v1beta2.Deployment, v1.CreateOptions) *v1beta2.Deployment); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *v1beta2.Deployment, v1.CreateOptions) error); ok {
...
func (_m *DeploymentInterface) Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta2.Deployment, error) {
	ret := _m.Called(ctx, name, opts)

	var r0 *v1beta2.Deployment
	if rf, ok := ret.Get(0).(func(context.Context, string, v1.GetOptions) *v1beta2.Deployment); ok {
		r0 = rf(ctx, name, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta2.Deployment)
...
func (_m *DeploymentInterface) List(ctx context.Context, opts v1.ListOptions) (*v1beta2.DeploymentList, error) {
	ret := _m.Called(ctx, opts)

	var r0 *v1beta2.DeploymentList
	if rf, ok := ret.Get(0).(func(context.Context, v1.ListOptions) *v1beta2.DeploymentList); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta2.DeploymentList)
		}
	}
...
func (_m *DeploymentInterface) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (*v1beta2.Deployment, error) {
	...
	var r0 *v1beta2.Deployment
	if rf, ok := ret.Get(0).(func(context.Context, string, types.PatchType, []byte, v1.PatchOptions, ...string) *v1beta2.Deployment); ok {
...
func (_m *DeploymentInterface) Update(ctx context.Context, deployment *v1beta2.Deployment, opts v1.UpdateOptions) (*v1beta2.Deployment, error) {
	ret := _m.Called(ctx, deployment, opts)

	var r0 *v1beta2.Deployment
	if rf, ok := ret.Get(0).(func(context.Context, *v1beta2.Deployment, v1.UpdateOptions) *v1beta2.Deployment); ok {
		r0 = rf(ctx, deployment, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta2.Deployment)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *v1beta2.Deployment, v1.UpdateOptions) error); ok {
		r1 = rf(ctx, deployment, opts)
	} else {
		r1 = ret.Error(1)
	}

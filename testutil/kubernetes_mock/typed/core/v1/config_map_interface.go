...
// NewConfigMapInterface creates a new instance of ConfigMapInterface. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewConfigMapInterface(t testing.TB) *ConfigMapInterface {

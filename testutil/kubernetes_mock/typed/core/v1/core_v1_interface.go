...
// NewCoreV1Interface creates a new instance of CoreV1Interface. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCoreV1Interface(t testing.TB) *CoreV1Interface {

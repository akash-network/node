...
// NewEndpointsInterface creates a new instance of EndpointsInterface. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEndpointsInterface(t testing.TB) *EndpointsInterface {

...
// NewEventsGetter creates a new instance of EventsGetter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEventsGetter(t testing.TB) *EventsGetter {
	mock := &EventsGetter{}
	mock.Mock.Test(t)

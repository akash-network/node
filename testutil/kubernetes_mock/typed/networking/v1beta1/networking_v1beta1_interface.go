...
// NewNetworkingV1beta1Interface creates a new instance of NetworkingV1beta1Interface. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewNetworkingV1beta1Interface(t testing.TB) *NetworkingV1beta1Interface {

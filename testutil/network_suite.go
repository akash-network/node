...
// 	SetupSuite()
// 	Validator(...int) *network.Validator
// 	WalletNameForTest() string
// 	ClientContextForTest() sdkclient.Context
// 	ClientContext(...int) sdkclient.Context
// 	ContextForTest() context.Context
// 	Network() *network.Network
// 	Config() network.Config
// 	ValidateTx(resultData []byte) string
// }

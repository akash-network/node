...
type ClusterClient interface {
	...
	ServiceLog(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (Cluster_ServiceLogClient, error)
}
...
func (c *clusterClient) ServiceLog(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (Cluster_ServiceLogClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Cluster_serviceDesc.Streams[0], c.cc, "/types.Cluster/ServiceLog", opts...)
	if err != nil {
		return nil, err
	}
	x := &clusterServiceLogClient{stream}
...
type Cluster_ServiceLogClient interface {
	Recv() (*Log, error)
	grpc.ClientStream
}

type clusterServiceLogClient struct {
	grpc.ClientStream
}

func (x *clusterServiceLogClient) Recv() (*Log, error) {
	m := new(Log)
...
type ClusterServer interface {
	...
	ServiceLog(*LogRequest, Cluster_ServiceLogServer) error
}
...
func _Cluster_ServiceLog_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(LogRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ClusterServer).ServiceLog(m, &clusterServiceLogServer{stream})
}

type Cluster_ServiceLogServer interface {
	Send(*Log) error
	grpc.ServerStream
}

type clusterServiceLogServer struct {
	grpc.ServerStream
}

func (x *clusterServiceLogServer) Send(m *Log) error {
...
var _Cluster_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "ServiceLog",
			Handler:       _Cluster_ServiceLog_Handler,
			ServerStreams: true,
		},
	},
...
var fileDescriptorTypes = []byte{
	...
	0xaf, 0xad, 0xac, 0x2f, 0x1c, 0x16, 0xad, 0xb8, 0xc1, 0x85, 0x03, 0x48, 0x20, 0x71, 0xe0, 0xc2,
	...
	,
	...
	0x03, 0xf4, 0xfe, 0xf1, 0x94, 0x68, 0x3d, 0xe1, 0x79, 0x7a, 0x84, 0x22, 0x00, 0x25, 0x97, 0x97,
	0x8e, 0x51, 0xa1, 0x7a, 0x77, 0xa3, 0x00, 0x9c, 0xb6, 0xd8, 0xeb, 0x5b, 0xce, 0x7b, 0x2d, 0x9f,
	0x76, 0xd9, 0x31, 0xb7, 0xba, 0xa5, 0x6b, 0xfd, 0x9a, 0xb5, 0x58, 0x7f, 0xfa, 0xfc, 0x82, 0xf5,
	0xf7, 0xe7, 0x17, 0xac, 0x2f, 0xbe, 0xbc, 0x60, 0x3d, 0xfd, 0xf2, 0x82, 0xb5, 0x53, 0x16, 0xc7,
	0xf6, 0xf5, 0x7f, 0x05, 0x00, 0x00, 0xff, 0xff, 0x22, 0x7a, 0x07, 0x51, 0x7c, 0x1f, 0x00, 0x00,
}

...
func (Lease_LeaseState) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{22, 0} }
...
type TxPayload_TxCloseOrder struct {
	TxCloseOrder *TxCloseOrder `protobuf:"bytes,5,opt,name=TxCloseOrder,oneof"`
}
...
type TxPayload_TxDeploymentClosed struct {
	TxDeploymentClosed *TxDeploymentClosed `protobuf:"bytes,10,opt,name=txDeploymentClosed,oneof"`
}
...
func (*TxPayload_TxCloseOrder) isTxPayload_Payload()        {}
...
func (m *TxPayload) GetTxCloseOrder() *TxCloseOrder {
	if x, ok := m.GetPayload().(*TxPayload_TxCloseOrder); ok {
		return x.TxCloseOrder
	}
	return nil
}
...
func _TxPayload_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *TxPayload_TxCloseOrder:
		_ = b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.TxCloseOrder); err != nil {
			return err
		}
...
func _TxPayload_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 4: // payload.txCreateOrder
		...
		return true, err
	case 5: // payload.TxCloseOrder
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TxCloseOrder)
		err := b.DecodeMessage(msg)
		m.Payload = &TxPayload_TxCloseOrder{msg}
		return true, err
	...
	case 9: // payload.txCloseDeployment
		...
		return true, err
	case 10: // payload.txDeploymentClosed
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
...
type DeploymentGroups struct {
	Items []DeploymentGroup `protobuf:"bytes,1,rep,name=items" json:"items"`
}
...
func (m *TxCloseOrder) Reset()                    { *m = TxCloseOrder{} }
func (m *TxCloseOrder) String() string            { return proto.CompactTextString(m) }
func (*TxCloseOrder) ProtoMessage()               {}
func (*TxCloseOrder) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{18} }

func (m *TxCloseOrder) GetOrder() *Order {
	if m != nil {
		return m.Order
	}
	return nil
...
func (*Orders) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{19} }
...
func (*Fulfillment) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{20} }
...
func (*TxCreateFulfillment) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{21} }
...
func (*Lease) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{22} }
...
func (*TxCreateLease) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{23} }
...
func init() {
	...
	proto.RegisterType((*TxCloseOrder)(nil), "types.TxCloseOrder")
...
func (this *TxPayload_TxCloseOrder) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&types.TxPayload_TxCloseOrder{` +
		`TxCloseOrder:` + fmt.Sprintf("%#v", this.TxCloseOrder) + `}`}, ", ")
	return s
}
...
func (this *DeploymentGroups) GoString() string {
	...
	if this.Items != nil {
		vs := make([]*DeploymentGroup, len(this.Items))
		for i := range vs {
			vs[i] = &this.Items[i]
		}
...
func (this *TxCloseOrder) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&types.TxCloseOrder{")
	if this.Order != nil {
		s = append(s, "Order: "+fmt.Sprintf("%#v", this.Order)+",\n")
	}
	s = append(s, "}")
...
func (m *TxPayload) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxCloseOrder", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Payload = &TxPayload_TxCloseOrder{v}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
...
func (m *TxCloseOrder) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TxCloseOrder: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TxCloseOrder: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorTypes = []byte{
	...
	,
}

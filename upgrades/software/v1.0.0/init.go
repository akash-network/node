...
func init() {
	...
	utypes.RegisterMigration(av1.ModuleName, 3, newAuditMigration)
	...
	utypes.RegisterMigration(ev1.ModuleName, 3, newEscrowMigration)
	utypes.RegisterMigration(mv1.ModuleName, 6, newMarketMigration)
	utypes.RegisterMigration(pv1.ModuleName, 3, newProviderMigration)
	utypes.RegisterMigration(tv1.ModuleName, 3, newTakeMigration)
}

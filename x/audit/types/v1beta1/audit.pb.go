...
type Provider struct {
	...
	Attributes github_com_ovrclk_akash_types_v1beta1.Attributes `protobuf:"bytes,4,rep,name=attributes,proto3,castrepeated=github.com/ovrclk/akash/types/v1beta1.Attributes" json:"attributes" yaml:"attributes"`
}

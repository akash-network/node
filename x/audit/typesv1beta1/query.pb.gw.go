...
/*
Package typesv1beta1 is a reverse proxy.
...
var (
	...
	pattern_Query_ProviderAuditorAttributes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"akash", "audit", "v1beta1", "attributes", "auditor", "owner"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AuditorAttributes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"akash", "provider", "v1beta1", "auditor", "list"}, "", runtime.AssumeColonVerbOpt(true)))
)

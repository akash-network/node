...
func NewAppModule(cdc codec.Codec, k keeper.Keeper, accKeeper bmeimports.AccountKeeper, bankKeeper bmeimports.BankKeeper) AppModule {
	return AppModule{
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	types.RegisterMsgServer(cfg.MsgServer(), handler.NewMsgServerImpl(am.keeper, am.acc, am.bank))

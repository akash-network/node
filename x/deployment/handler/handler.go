...
func NewHandler(keeper keeper.IKeeper, mkeeper dimports.MarketKeeper, ekeeper dimports.EscrowKeeper, bme dimports.BMEKeeper, bankKeeper dimports.BankKeeper) baseapp.MsgServiceHandler {
	ms := NewServer(keeper, mkeeper, ekeeper, bme, bankKeeper)

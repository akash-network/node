...
func Test_AccountDeposit(t *testing.T) {
}

func Test_AccountSettle(t *testing.T) {
}

func Test_AccountClose(t *testing.T) {
}
...
func Test_PaymentCreate(t *testing.T) {
	...
	// closing the account transferrs all remaining funds
	bkeeper.
...
func setupKeeper(t testing.TB) (sdk.Context, keeper.Keeper, *mocks.BankKeeper) {
	...
	bkeeper := &mocks.BankKeeper{}
	return ctx, keeper.NewKeeper(types.ModuleCdc, key, bkeeper), bkeeper
}

...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	cdc.RegisterConcrete(&MsgAccountWithdraw{}, ModuleName+"/"+MsgTypeAccountWithdraw, nil)
	cdc.RegisterConcrete(&MsgPaymentWithdraw{}, ModuleName+"/"+MsgTypePaymentWithdraw, nil)
}

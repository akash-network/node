...
type Account struct {
	...
	TotalBalance   types.Coin    `protobuf:"bytes,4,opt,name=total_balance,json=totalBalance,proto3" json:"totalBalance" yaml:"totalBalance"`
	...
	CreditsBalance types.Coin    `protobuf:"bytes,7,opt,name=credits_balance,json=creditsBalance,proto3" json:"creditsBalance" yaml:"creditsBalance"`
	TokensBalance  types.Coin    `protobuf:"bytes,8,opt,name=tokens_balance,json=tokensBalance,proto3" json:"tokensBalances" yaml:"tokensBalance"`
}
...
var fileDescriptor_3d89eca75409f317 = []byte{
	...
	,
}

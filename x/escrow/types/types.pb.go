...
type Account struct {
	...
	CreditsBalance types.Coin    `protobuf:"bytes,4,opt,name=credits_balance,json=creditsBalance,proto3" json:"balance" yaml:"creditsBalance"`
	TokensBalance  types.Coin    `protobuf:"bytes,5,opt,name=tokens_balance,json=tokensBalance,proto3" json:"tokensBalances" yaml:"tokensBalance"`
	TotalBalance   types.Coin    `protobuf:"bytes,6,opt,name=total_balance,json=totalBalance,proto3" json:"totalBalance" yaml:"totalBalance"`
	Transferred    types.Coin    `protobuf:"bytes,7,opt,name=transferred,proto3" json:"transferred" yaml:"transferred"`
	SettledAt      int64         `protobuf:"varint,8,opt,name=settled_at,json=settledAt,proto3" json:"settledAt" yaml:"settledAt"`
}
...
func (m *Account) GetCreditsBalance() types.Coin {
	if m != nil {
		return m.CreditsBalance
	}
	return types.Coin{}
}

func (m *Account) GetTokensBalance() types.Coin {
	if m != nil {
		return m.TokensBalance
	}
	return types.Coin{}
}

func (m *Account) GetTotalBalance() types.Coin {
	if m != nil {
...
var fileDescriptor_3d89eca75409f317 = []byte{
	...
	,
}
...
func (m *Account) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x32
	{
		size, err := m.TokensBalance.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x2a
	{
		size, err := m.CreditsBalance.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Account) Size() (n int) {
	...
	l = m.CreditsBalance.Size()
	n += 1 + l + sovTypes(uint64(l))
	l = m.TokensBalance.Size()
	n += 1 + l + sovTypes(uint64(l))
...
func (m *Account) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreditsBalance", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CreditsBalance.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TokensBalance", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TokensBalance.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:

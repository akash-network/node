...
// source: akash/intertx/query.proto
...
func (*QueryInterchainAccountFromAddressRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_21c38385d3374c26, []int{0}
}
...
func (*QueryInterchainAccountFromAddressResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_21c38385d3374c26, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryInterchainAccountFromAddressRequest)(nil), "akash.intertx.QueryInterchainAccountFromAddressRequest")
	proto.RegisterType((*QueryInterchainAccountFromAddressResponse)(nil), "akash.intertx.QueryInterchainAccountFromAddressResponse")
}

func init() { proto.RegisterFile("akash/intertx/query.proto", fileDescriptor_21c38385d3374c26) }

var fileDescriptor_21c38385d3374c26 = []byte{
	// 319 bytes of a gzipped FileDescriptorProto
	,
	...
	0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0xfd, 0xfc, 0xb2, 0xa2, 0xe4, 0x9c, 0x6c, 0x7d, 0x48, 0xea, 0xa8,
	0x80, 0xa4, 0x0f, 0xdd, 0x92, 0x0a, 0xfd, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0xe4,
	0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x4a, 0x1f, 0xa0, 0x30, 0x3e, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) InterchainAccountFromAddress(ctx context.Context, in *QueryInterchainAccountFromAddressRequest, opts ...grpc.CallOption) (*QueryInterchainAccountFromAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/akash.intertx.Query/InterchainAccountFromAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_InterchainAccountFromAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/akash.intertx.Query/InterchainAccountFromAddress",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "akash.intertx.Query",
	...
	Metadata: "akash/intertx/query.proto",
}

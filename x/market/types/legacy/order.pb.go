...
func init() {
	proto.RegisterEnum("akash.market.v1beta1legacy.Order_State", Order_State_name, Order_State_value)
	proto.RegisterType((*OrderID)(nil), "akash.market.v1beta1legacy.OrderID")
	proto.RegisterType((*Order)(nil), "akash.market.v1beta1legacy.Order")
	proto.RegisterType((*OrderFilters)(nil), "akash.market.v1beta1legacy.OrderFilters")
}
